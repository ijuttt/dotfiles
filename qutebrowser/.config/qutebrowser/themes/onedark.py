...
c.colors.statusbar.url.fg = bg_insert_mode
...
c.colors.tabs.pinned.selected.odd.fg = bg_default

# Foreground color of selected odd tabs.
c.colors.tabs.selected.odd.fg = bg_default

# Background color of selected odd tabs.
c.colors.tabs.selected.odd.bg = bg_insert_mode

# Foreground color of selected even tabs.
c.colors.tabs.selected.even.fg = bg_default

# Background color of selected even tabs.
c.colors.tabs.selected.even.bg = bg_insert_mode
